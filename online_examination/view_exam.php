	...
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">
				...
				<button class="center">Submit Test</button>
		</div>
		<br />
...
$(document).ready(function(){
	...
	var page_redirect = "<?php echo $home_page; ?>";
	...
	var myVar = setInterval(function(){
		...
		if(remaining_second < 1)
		{
            ...
            window.location.assign(page_redirect+"enroll_exam.php");
